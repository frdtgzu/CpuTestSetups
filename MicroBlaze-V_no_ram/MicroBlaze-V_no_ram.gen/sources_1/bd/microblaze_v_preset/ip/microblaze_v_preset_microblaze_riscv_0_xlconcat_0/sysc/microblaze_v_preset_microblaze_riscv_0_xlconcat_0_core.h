...
#ifndef _microblaze_v_preset_microblaze_riscv_0_xlconcat_0_core_h_
#define _microblaze_v_preset_microblaze_riscv_0_xlconcat_0_core_h_
...
class microblaze_v_preset_microblaze_riscv_0_xlconcat_0_core : public sc_module 
{
    public: 
       microblaze_v_preset_microblaze_riscv_0_xlconcat_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(microblaze_v_preset_microblaze_riscv_0_xlconcat_0_core);
    ...
    virtual ~microblaze_v_preset_microblaze_riscv_0_xlconcat_0_core() = default;
