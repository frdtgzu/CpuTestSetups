...
HD_PWD='/home/vid/Desktop/Projects/MicroBlaze-V_no_ram/MicroBlaze-V_no_ram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_v_preset_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_v_preset_wrapper.tcl
