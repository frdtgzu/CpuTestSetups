...
#
# Script generated by Vivado on Fri May 23 13:45:54 CEST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : microblaze_v_preset.sh
...
#
# Usage        : microblaze_v_preset.sh
#                microblaze_v_preset.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                microblaze_v_preset.sh [-reset_run]
#                microblaze_v_preset.sh [-reset_log]
#                microblaze_v_preset.sh [-help]
#
...
#                script (type 'microblaze_v_preset.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_lite_ipif_v3_0_4 -libname lib_cdc_v1_0_3 -libname lib_pkg_v1_0_4 -libname axi_timer_v2_0_35 -libname xil_defaultlib -libname lib_srl_fifo_v1_0_4 -libname axi_uartlite_v2_0_37 -libname xlconcat_v2_1_6 -libname proc_sys_reset_v5_0_16 -libname xlconstant_v1_1_9 -libname smartconnect_v1_0 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_33 -libname axi_vip_v1_1_19 -libname axi_intc_v4_1_20 -libname mdm_riscv_v1_0_3 -libname microblaze_v11_0_14 -libname microblaze_riscv_v1_0_3 -libname lmb_v10_v3_0_14 -libname lmb_bram_if_cntlr_v4_0_25 -libname blk_mem_gen_v8_4_9 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_lite_ipif_v3_0_4 lib_cdc_v1_0_3 lib_pkg_v1_0_4 axi_timer_v2_0_35 xil_defaultlib lib_srl_fifo_v1_0_4 axi_uartlite_v2_0_37 xlconcat_v2_1_6 proc_sys_reset_v5_0_16 xlconstant_v1_1_9 smartconnect_v1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_33 axi_vip_v1_1_19 axi_intc_v4_1_20 mdm_riscv_v1_0_3 microblaze_v11_0_14 microblaze_riscv_v1_0_3 lmb_v10_v3_0_14 lmb_bram_if_cntlr_v4_0_25 blk_mem_gen_v8_4_9)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "microblaze_v_preset.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./microblaze_v_preset.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/3cbc" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/f0b6/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/0127/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xlconcat_v2_1_6 $xmvlog_opts +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/3cbc" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/f0b6/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/0127/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/6120/hdl/xlconcat_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/3cbc" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/f0b6/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/0127/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work smartconnect_v1_0 $xmvlog_opts -sv +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/3cbc" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/f0b6/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/0127/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/3cbc" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/f0b6/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/0127/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/3cbc" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/f0b6/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/0127/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_33 $xmvlog_opts +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/3cbc" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/f0b6/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/0127/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/3ee4/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_19 $xmvlog_opts -sv +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/3cbc" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/f0b6/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/0127/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_9 $xmvlog_opts +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/3cbc" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/f0b6/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/0127/hdl/verilog" +incdir+"../../../../MicroBlaze-V_no_ram.gen/sources_1/bd/microblaze_v_preset/ipshared/ec67/hdl" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.microblaze_v_preset xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.microblaze_v_preset -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/vid/Desktop/Projects/MicroBlaze-V_no_ram/MicroBlaze-V_no_ram.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log microblaze_v_preset_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./microblaze_v_preset.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: microblaze_v_preset.sh [-help]\n\
Usage: microblaze_v_preset.sh [-step]\n\
Usage: microblaze_v_preset.sh [-lib_map_path]\n\
Usage: microblaze_v_preset.sh [-reset_run]\n\
Usage: microblaze_v_preset.sh [-reset_log]\n\
Usage: microblaze_v_preset.sh [-keep_index]\n\
Usage: microblaze_v_preset.sh [-noclean_files]\n\n\
