...
HD_PWD='/home/vid/Desktop/Projects/MicroBlaze_no_ram/MicroBlaze_no_ram.runs/system_lmb_bram_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_lmb_bram_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_lmb_bram_3.tcl
