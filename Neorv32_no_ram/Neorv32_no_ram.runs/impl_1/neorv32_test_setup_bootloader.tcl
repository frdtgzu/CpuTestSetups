namespace eval ::optrace {
  variable script "/home/vid/Desktop/Projects/Neorv32_no_ram/Neorv32_no_ram.runs/impl_1/neorv32_test_setup_bootloader.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /home/vid/Desktop/Projects/Neorv32_no_ram/Neorv32_no_ram.runs/synth_1/neorv32_test_setup_bootloader.dcp
...
OPTRACE "link_design" START { }
  link_design -top neorv32_test_setup_bootloader -part xc7a100tcsg324-1 
...
OPTRACE "opt_design reports" START { REPORT }
  ...
  generate_parallel_reports -reports { "report_drc -file neorv32_test_setup_bootloader_drc_opted.rpt -pb neorv32_test_setup_bootloader_drc_opted.pb -rpx neorv32_test_setup_bootloader_drc_opted.rpx"  }
...
OPTRACE "place_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_io -file neorv32_test_setup_bootloader_io_placed.rpt" "report_utilization -file neorv32_test_setup_bootloader_utilization_placed.rpt -pb neorv32_test_setup_bootloader_utilization_placed.pb" "report_control_sets -verbose -file neorv32_test_setup_bootloader_control_sets_placed.rpt"  }
  set_param project.isImplRun false
...
OPTRACE "route_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_drc -file neorv32_test_setup_bootloader_drc_routed.rpt -pb neorv32_test_setup_bootloader_drc_routed.pb -rpx neorv32_test_setup_bootloader_drc_routed.rpx" "report_methodology -file neorv32_test_setup_bootloader_methodology_drc_routed.rpt -pb neorv32_test_setup_bootloader_methodology_drc_routed.pb -rpx neorv32_test_setup_bootloader_methodology_drc_routed.rpx" "report_power -file neorv32_test_setup_bootloader_power_routed.rpt -pb neorv32_test_setup_bootloader_power_summary_routed.pb -rpx neorv32_test_setup_bootloader_power_routed.rpx" "report_route_status -file neorv32_test_setup_bootloader_route_status.rpt -pb neorv32_test_setup_bootloader_route_status.pb" "report_timing_summary -max_paths 10 -report_unconstrained -file neorv32_test_setup_bootloader_timing_summary_routed.rpt -pb neorv32_test_setup_bootloader_timing_summary_routed.pb -rpx neorv32_test_setup_bootloader_timing_summary_routed.rpx -warn_on_violation " "report_incremental_reuse -file neorv32_test_setup_bootloader_incremental_reuse_routed.rpt" "report_clock_utilization -file neorv32_test_setup_bootloader_clock_utilization_routed.rpt" "report_bus_skew -warn_on_violation -file neorv32_test_setup_bootloader_bus_skew_routed.rpt -pb neorv32_test_setup_bootloader_bus_skew_routed.pb -rpx neorv32_test_setup_bootloader_bus_skew_routed.rpx"  }
  set_param project.isImplRun false
...
OPTRACE "read constraints: write_bitstream" END { }
  catch { write_mem_info -force -no_partial_mmi neorv32_test_setup_bootloader.mmi }
OPTRACE "write_bitstream setup" END { }
OPTRACE "write_bitstream" START { }
  write_bitstream -force neorv32_test_setup_bootloader.bit 
OPTRACE "write_bitstream" END { }
OPTRACE "write_bitstream misc" START { }
OPTRACE "read constraints: write_bitstream_post" START { }
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force neorv32_test_setup_bootloader}
  catch {file copy -force neorv32_test_setup_bootloader.ltx debug_nets.ltx}
